...
from database.orm_queries import orm_get_banner, orm_get_categories, orm_get_products, orm_delete_from_cart, \
...
async def get_menu_content(session: AsyncSession, level: int, menu_name: str,
                           category: int | None = None, page: int | None = None,
                           user_id: int | None = None, product_id: int | None = None):
    if level == 0:
